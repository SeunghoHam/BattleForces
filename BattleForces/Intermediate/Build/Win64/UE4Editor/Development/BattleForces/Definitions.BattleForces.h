...
#define UE_PROJECT_NAME BattleForces
#define UE_TARGET_NAME BattleForcesEditor
#define UE_MODULE_NAME "BattleForces"
...
#define BATTLEFORCES_API DLLEXPORT
